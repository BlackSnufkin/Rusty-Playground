...
use winapi::um::{
    ...
    securitybaseapi::{AdjustTokenPrivileges, DuplicateTokenEx, ImpersonateLoggedOnUser},
    ...
    winnt::{
        ...
        TOKEN_ASSIGN_PRIMARY, TOKEN_DUPLICATE, TOKEN_IMPERSONATE, TOKEN_PRIVILEGES, TOKEN_QUERY, SE_PRIVILEGE_ENABLED,
        HANDLE, LUID
    },
};
use regex::Regex;
...
fn main () {
    ...
    match result {
        ...
        Err(e) => eprintln!("[x] Error enabling privileges: {}", e),
    }
